...
#
#    escenario: Registro fallido por correo electrónico ya registrado
#        Dado que estoy en la página de registro
#        Cuando ingreso un correo electrónico que ya está registrado
#        Y hago clic en el botón de "Registrarse"
#        Entonces debería ver un mensaje de error indicando que el correo ya está en uso